    ...
    public partial class GiaoDien : Form
    {
        ...
        private void DisplaySelectedRowData(int customerId)
        {
            ...
            if (cus != null)
            {
                ...
                {
                    string imagePath = Path.Combine(@"D:\laptrinhwindows\baocaolaptrinhwindows\NguyenVoLinh-2121110083\NguyenVoLinh-2121110083\img", nameimg);
            ...
            try
            {
                ...
                if (ValidateInput())
                {
                    ...
                    if (row != null)
                    {
                        ...
                        row.Cells[6].Value = cus.Anh;
                        row.Cells[5].Value = cus.DanhMucName;
